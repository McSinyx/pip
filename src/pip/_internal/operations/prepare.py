...
def get_http_url(
    ...
    if already_downloaded_path:
        ...
        from_path, content_type = downloader.download_file(
            link, temp_dir.path, hashes)
...
class RequirementPreparer(object):
    ...
    def _ensure_link_req_src_dir(self, req, download_dir, parallel_builds):
        ...
        req.ensure_has_source_dir(
            ...
            # For wheels however, we keep them if the operation
            # is download.  During installation of wheels,
            # unpacked wheels are only used to get metadata.
            autodelete=req.link.is_wheel and bool(download_dir),
